 ...
 */
class OAuthProviderAlreadyConnectedException(
    provider: String,
) : MemberException(
 ...
 */
class OAuthProviderNotConnectedException(
    provider: String,
) : MemberException(
 ...
 * 암호화 설정을 찾을 수 없는 경우
 */
class EncryptionSettingsNotFoundException(
    memberId: String,
) : MemberException(
 ...
 * 암호화가 이미 설정된 경우
 */
class EncryptionAlreadySetupException(
    memberId: String,
) : MemberException(
 ...
 * OAuth 토큰 검증 실패
 */
class OAuthTokenValidationFailedException(
    provider: String,
) : MemberException(
 ...
 * OAuth 토큰 교환 실패
 */
class OAuthTokenExchangeFailedException(
    provider: String,
) : MemberException(
 ...
 */
class OAuthStateValidationFailedException :
    MemberException(
 ...
 */
class OAuthAlreadyLinkedToAnotherMemberException(
    provider: String,
) : MemberException(
 ...
 */
class CannotDisconnectLastLoginMethodException :
    MemberException(
 ...
 */
class PasswordAlreadySetException :
    MemberException(
